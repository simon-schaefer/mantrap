...
- IPOPT (fast ! Vincent Laurense, cascaded MPC, speed racing)
...
\begin{equation}
J_{goal} = \frac{1}{T} \sum_{t = 0}^T ||X_R^t - \mathcal{G}_R||_2
\end{equation}
...
- comparison between mean and weighted sum of point-wise objectives
