...
%todo: perfect perception ie knowledge about current and past states of all surrounding agents
...
% todo: shooting with z = ego controls ($z = U_R$)
% todo: nonzero in equality \& inequality Jacobian, Hessian, number of variables, number of constraints 
% todo: wikipedia description \href{https://en.wikipedia.org/wiki/Trajectory_optimization}{wiki}
% todo: \ac{IPOPT} (fast ! c, cascaded MPC, speed racing)
% todo: Trajectory Optimization (Shooting vs Collocation) \href{https://epubs.siam.org/doi/pdf/10.1137/16M1062569}{tutorial}
% todo: KKT conditions ??
% todo: system implementation verified by roughly 1000 unit- and integration tests in a continuous integration manner (CircleCI and CodeCov) 
...
%todo: jacobian: speed of convergence
