...
%todo: do not list papers !!!  a lot of different methods for planning in crowds different axes: interpretable optimization, accurate behavior prediction, but find general topics e.g. 
...
% 3. types of trajectory optimization (shooting, collocation, etc.)
