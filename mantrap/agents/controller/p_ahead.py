...
from mantrap.agents.base import DTAgent
...
def p_ahead_controller(
    ...
    speed_reference = speed_reference if speed_reference is not None else agent.speed_limits[1]
    ...
    min_breaking_time = min(max(min_breaking_time, 1), num_path_points)
