...
from mantrap.objectives import InteractionAccelerationModule
from mantrap.objectives import ControlEffortModule
from mantrap.objectives.goal import GoalModule
from mantrap.objectives import InteractionPositionModule
