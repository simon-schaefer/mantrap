...
#     """
#
#     def determine_ego_action(self, env: GraphBasedSimulation) -> np.ndarray:
...
#
#     @abstractmethod
#     def compute_interaction_grad(self, env: GraphBasedSimulation, ego_query: np.ndarray):
#         pass
#
#     @staticmethod
#     def close_ados(env: GraphBasedSimulation):
#         ados_close = []
#         for ado in env.ados:
