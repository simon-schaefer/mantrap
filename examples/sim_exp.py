...
solver = SGradSolver(sim, goal=ego_goal, verbose=False, t_planning=10)

x_opt, ado_traj, x_opt_planned, ado_traj_planned = solver.solve(time_steps=20, max_cpu_time=10.0)
visualize_scenes(x_opt_planned, ado_traj_planned, env=sim, file_path=build_os_path("test/graphs/sim_exp"))
